...
public interface DataDictionaryService extends BaseService<DataDictionaryEntity>{
	 ...
	 * @return
	 */
	List<DataDictionaryEntity> selectParentAndSubByCode(Map<String,Object> map);
	 ...
	 * @return
	 */
	List<DataDictionaryEntity> getSubDataByCode(String code);
	 ...
	 * @return
	 */
	List<DataDictionaryDTO> getSubDataByCodeToDTO(String code) throws Exception;
	 ...
	 * @return
	 */
	List<DataDictionaryEntity> getDataByParemeter(Map<String,Object> map);
	 ...
	 * @return
	 */
	Map<String, String> ddMap(String code);
}

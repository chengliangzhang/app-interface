...
public class ProjectCostPointDaoImpl extends GenericDao<ProjectCostPointEntity> implements ProjectCostPointDao {
     ...
     */
    @Override
    public int updateByPid(String id) {
        return this.sqlSession.update("ProjectCostPointEntityMapper.updateByPid",id);
    }
    ...
    @Override
    public ProjectCostPointEntity getCostPointByTaskIdForTechincal(String taskId) {
        return this.sqlSession.selectOne("ProjectCostPointEntityMapper.getCostPointByTaskIdForTechincal", taskId);
    }
     ...
     */
    @Override
    public String getPointNameByDetailId(String pointDetailId) {
        return this.getPointName(pointDetailId,null);
    }
     ...
     */
    @Override
    public String getPointNameByPaymentId(String paymentDetailId) {
        return this.getPointName(null,paymentDetailId);
    }
     ...
     * 日期：2017/6/28
     */
    public String getPointName(String pointDetailId, String paymentDetailId) {
        Map<String,Object> map = new HashMap<String,Object>();
        map.put("pointDetailId",pointDetailId);
        map.put("paymentDetailId",paymentDetailId);
        return this.sqlSession.selectOne("ProjectCostPointEntityMapper.getPointName", map);
    }

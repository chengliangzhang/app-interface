...
public class ProjectConstructServiceImpl extends GenericService<ProjectConstructEntity> implements ProjectConstructService {
     ...
     */
    @Override
    public AjaxMessage saveOrUpdateProjectConstructInterface(ProjectConstructDTO dto) throws Exception{
    ...
    public ProjectConstructDTO getProjectConstructByIdAndOtherDetail(String id, String companyId, String projectId) throws Exception {
        ...
        //List<ProjectConstructDetailEntity> OtherDetaiList = projectConstructDetailDao.getOtherConstructDetail(map);
       // projectConstructDTO.setOtherDetaiList(BaseDTO.copyFields(OtherDetaiList,ProjectConstructDetailDTO.class));
     ...
     */
    @Override
    public ProjectConstructDTO getProjectConstructByIdAndOtherDetailInterface(String id, String companyId, String projectId) throws Exception {
        ProjectConstructDTO projectConstructDTO = new ProjectConstructDTO();
        ProjectConstructEntity projectConstructEntity = projectConstructDao.selectById(id);
        if(projectConstructEntity!=null){
            BaseDTO.copyFields(projectConstructEntity,projectConstructDTO);
        ...
        if(!StringUtil.isNullOrEmpty(projectId)){
            ...
            //为了没有projectId时，全部不查出来
            map.put("noProjectId","noProjectId");
        }
        List<ProjectConstructDetailEntity> OtherDetaiList = projectConstructDetailDao.getOtherConstructDetailInterface(map);
        projectConstructDTO.setOtherDetaiList(BaseDTO.copyFields(OtherDetaiList,ProjectConstructDetailDTO.class));

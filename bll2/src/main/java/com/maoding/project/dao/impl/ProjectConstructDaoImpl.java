...
public class ProjectConstructDaoImpl extends GenericDao<ProjectConstructEntity> implements ProjectConstructDao {
     ...
     */
    @Override
    public ProjectConstructEntity getConstructByName(String companyName,String companyId) {
        Map<String,Object> map = new HashMap<String,Object>();
        map.put("companyName",companyName);
        map.put("companyId",companyId);
        return this.sqlSession.selectOne("ProjectConstructEntityMapper.getConstructByName",map);
    }
     ...
     * @return
     */
    public List<ProjectConstructDTO> getConstructByName(Map<String,Object> paramMap){
        List<ProjectConstructDTO> list = this.sqlSession.selectList("ProjectConstructEntityMapper.selectByCompanyName",paramMap);
        return list;
    }
    /**
     * 方法描述：根据当前组织ID查找

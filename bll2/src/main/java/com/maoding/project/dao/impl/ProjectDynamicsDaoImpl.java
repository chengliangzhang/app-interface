...
public class ProjectDynamicsDaoImpl extends GenericDao<ProjectDynamicsEntity> implements ProjectDynamicsDao {
     ...
     */
    @Override
    public List<OrgDynamicDataDTO> getProjectDynamicsPage(Map<String, Object> param){
        return this.sqlSession.selectList("GetProjectDynamicMapper.selectByParam",param);
    }

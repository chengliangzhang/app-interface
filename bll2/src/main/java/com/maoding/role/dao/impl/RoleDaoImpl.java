...
public class RoleDaoImpl extends GenericDao<RoleEntity> implements RoleDao {
	...
	@Override
	public List<RoleDataDTO> getCompanyRoleDTO(String companyId) {
	...
	@Override
	public String getUserRoleCodes(String userId, String orgId) {
		Map<String,Object> param = new HashMap<String,Object>();
		param.put("userId", userId);
		param.put("orgId", orgId);
		return this.sqlSession.selectOne("RoleEntityMapper.getUserRoleCodes", param);
	}

    @Override
	public List<String> getUserIdByRoleName(Map<String,Object> param){
		return this.sqlSession.selectList("RoleEntityMapper.getUserIdByName",param);
	}

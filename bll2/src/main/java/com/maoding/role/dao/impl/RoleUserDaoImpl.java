...
public class RoleUserDaoImpl extends GenericDao<RoleUserEntity> implements RoleUserDao {
	...
	/**
	 * 方法描述：根据角色获取记录（companyId必传）  -- 此处用于删除角色使用
	 * 作        者：MaoSF
	 ...
	 */
	@Override
	public List<RoleUserEntity> selectUserRole(Map<String, Object> param) {
		return this.sqlSession.selectList("RoleUserEntityMapper.selectUserRole", param);
	}

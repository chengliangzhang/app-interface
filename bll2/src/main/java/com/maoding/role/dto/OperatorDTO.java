...
public class OperatorDTO implements Serializable {
    ...
    private int subOrgInvite;//分支机构加入组织
    ...
    private int partnerInvite;//邀请事业合伙人加入组织
    ...
    private int approveModule = 1;//app端审批入口
    ...
    //项目模块
    private int projectModule=1;//项目模块
    ...
    public void setDepartEdit(int departEdit) {
        ...
        this.departDelete = departEdit;
        this.departCreate = departEdit;
    }
    ...
    public void setCompanyUserEdit(int companyUserEdit) {
        ...
        this.companyUserCreate = companyUserEdit;
        this.companyUserInvite = companyUserEdit;
        this.companyUserDelete = companyUserEdit;
    }
    ...
    public int getBackGroundManager() {
        ...
        if(companyModule==1 || companyUserModule==1  || departModule==1
                || subOrgModule == 1 || partnerModule ==1 ){ //roleModule==1 || companyAuth==1 ||  projectImport==1
            backGroundManager = 1;
        }
    ...
    public int getCompanyUserModule() {
        if(companyUserCreate==1 || companyUserEdit==1 || companyUserDelete ==1
                ||  companyUserInvite==1){ //companyUserImport==1 ||
            companyUserModule = 1;
        }
    ...
    public int getOrgEdit() {
        //编辑组织信息 包括（管理人员、管理部门、创建分支机构、邀请分支机构、邀请事业合伙人）
        if(companyUserModule==1 || departModule==1 || subOrgModule==1 || partnerModule==1){
            orgEdit = 1;
        }
        return orgEdit;
    ...
    public int getPartnerOrgCreate() {
        partnerOrgCreate = partnerCreate;
        return partnerOrgCreate;
    }

    public void setPartnerOrgCreate(int partnerOrgCreate) {
        this.partnerOrgCreate = partnerOrgCreate;
        this.partnerCreate = this.partnerOrgCreate;
        this.partnerEdit = this.partnerOrgCreate;
    }

    public int getProjectDocView() {
        projectDocView = projectDocModule;
        return projectDocView;
    }

    public void setProjectDocView(int projectDocView) {
        this.projectDocView = projectDocView;
    }
    ...
    public int getLaborHourModule() {
        return laborHourModule;
    }

    public void setLaborHourModule(int laborHourModule) {
        this.laborHourModule = laborHourModule;
    }

    public int getCalendarModule() {
        return calendarModule;
    }

    public void setCalendarModule(int calendarModule) {
        this.calendarModule = calendarModule;
    }

    public int getLightTaskModule() {
        return lightTaskModule;
    }

    public void setLightTaskModule(int lightTaskModule) {
        this.lightTaskModule = lightTaskModule;
    }
    ...
    public void setApproveModule(int approveModule) {
        this.approveModule = approveModule;
    }

    public int getOrgMultipleEdit() {
        if(companyUserCreate==1 || departModule==1 || subOrgCreate==1 || partnerInvite==1){
            orgMultipleEdit = 1;
        }
        return orgMultipleEdit;
    }

    public void setOrgMultipleEdit(int orgMultipleEdit) {
        this.orgMultipleEdit = orgMultipleEdit;
    }

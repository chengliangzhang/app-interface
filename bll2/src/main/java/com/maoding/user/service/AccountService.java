...
public interface AccountService extends BaseService<AccountEntity>{
	 ...
	 * @return
	 */
    AjaxMessage register(AccountDTO dto) throws Exception;
	 ...
	 * @return
	 */
    AccountEntity getAccountByCellphoneOrEmail(String cellphone) throws Exception;
	 ...
	 * @return
	 */
    AccountDTO getAccountDtoByCellphoneOrEmail(String cellphone) throws Exception;
	 ...
	 * 日        期：2016年7月7日-上午11:33:07
	 */
    List<AccountEntity> selectAll()throws Exception;
	 ...
	 * 日        期：2016/12/31
	 */
    ResponseBean v2RegisterCompanyOfWork(RegisterCompanyDTO dto, String accountId) throws Exception;

...
public class DepartDaoImpl extends GenericDao<DepartEntity> implements DepartDao{
    ...
    @Override
	public List<DepartDTO> getDepartByCompanyId(Map<String,Object>paraMap){
	 ...
	 * @return
	 */
	public List<DepartEntity> getDepartByCompanyIdAndUserId(Map<String,Object>paraMap){
		return this.sqlSession.selectList("GetDepartByCompanyIdMapper.getDepartByCompanyIdAndUserId",paraMap);
	}
	 ...
	 */
	@Override
	public int deleteByDepartPath2(String departPath) {
		return this.sqlSession.delete("DepartEntityMapper.deleteByDepartPath2",departPath);
	}

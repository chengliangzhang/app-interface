...
public interface CompanyRelationService extends BaseService<CompanyRelationEntity>{
	 ...
	 */
	public List<CompanyRelationDTO> getCompanyRelationByParam(Map<String,Object> param)throws Exception;
	 ...
	 * 日        期：2016年7月11日-下午10:27:38
	 */
	public int getCompanyRelationByParamCount(Map<String,Object> param)throws Exception;


	OrgRelationDataDTO getCooperatorData(Map<String,Object> param)throws Exception;
}

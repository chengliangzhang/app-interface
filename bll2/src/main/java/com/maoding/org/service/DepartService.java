...
public interface DepartService extends BaseService<DepartEntity>{
	 ...
	 * @return
	 */
    List<DepartDTO> getDepartByCompanyIdAndUserId(Map<String, Object> paraMap)throws Exception;
	 ...
	 * @return
	 */
    List<DepartDTO> getDepartByUserIdContentCompanyInterface(Map<String, Object> paraMap) throws Exception;
	 ...
	 * @throws Exception
	 */
    AjaxMessage deleteDepart(String id)throws Exception;
	 ...
	 * @return
	 */
    List<DepartDTO> getDepartByCompanyIdWS(Map<String, Object> paraMap)throws Exception;
	 ...
	 * @return:
	 */
	ResponseBean getDepartAndGroup(Map<String, Object> mapass) throws Exception;
}

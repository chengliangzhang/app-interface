...
public interface SystemParameters {
	...
	Map<String,MessageTemplate> message2=new HashMap<String,MessageTemplate>(){
		{
			/** 参数对照 ***
	...
	int MESSAGE_TYPE_407 = 407;//所有的生产任务已经完成，给本组织的设计负责人推送消息：“卯丁科技大厦一期-方案设计(此处是该团队自己生产的所有的生产的根任务)”的设计任务已完成，请你确认，
	int MESSAGE_TYPE_408 = 408;//所有的生产任务已经完成（包含签发出去的任务），签发方组织的设计负责人推送消息：“卯丁科技大厦一期-方案设计”的设计任务已完成，请你确认，
	int MESSAGE_TYPE_409 = 409;////合作方 A 给 B的任务全部完成，给A组织的设计负责人推送消息:所有的生产任务已经完成，签发方组织的设计负责人推送消息：“卯丁科技大厦一期-方案设计”的设计任务已完成，请你确认，
	...
	int MESSAGE_TYPE_223 = 223;//费用申请（拒绝）
	int MESSAGE_TYPE_224 = 224;//费用申请（同意）
	...
	int MESSAGE_TYPE_707 = 707; //参加会议
	int MESSAGE_TYPE_708 = 708; //不参加会议
